        ...
        <section class="clean-block clean-services dark" style="text-align: center;margin-top: 90px;padding-bottom: 0;background: rgb(255,255,255);">
            <div class="container py-4 py-xl-5" style="position: static;">
                ...
                <div class="row gy-4 gy-md-0">
                    <div class="col">
                        <p>Blade is a beautiful boutique located downtown Toronto with a welcoming, fun &amp; personable environment. Request of private studio time can be accommodated for your SMP service at no extra cost. Treat blade like your home during your treatment with your personal TV with Netflix &amp; YouTube at your fingertips.</p>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <section class="py-4 py-xl-5">
                            <div class="container">
                                <div class="row gx-2 gy-2 row-cols-1 row-cols-md-2 row-cols-xl-3" data-bss-baguettebox="">
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-01.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment one" src="{{ asset('/static/img/about-blade-smp-gallery-01.jpg') }}"></a></div>
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-03.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment two" src="{{ asset('/static/img/about-blade-smp-gallery-03.jpg') }}"></a></div>
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-02.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment three" src="{{ asset('/static/img/about-blade-smp-gallery-02.jpg') }}"></a></div>
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-06.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment four" src="{{ asset('/static/img/about-blade-smp-gallery-06.jpg') }}"></a></div>
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-04.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment five" src="{{ asset('/static/img/about-blade-smp-gallery-04.jpg') }}"></a></div>
                                    <div class="col"><a href="static/img/about-blade-smp-gallery-05.jpg"><img class="img-fluid" alt="scalp micropigmentation treatment six" src="{{ asset('/static/img/about-blade-smp-gallery-05.jpg') }}"></a></div>
                                </div>
                            </div>
                        </section>
                    </div>
